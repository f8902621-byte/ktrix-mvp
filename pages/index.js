          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {[
                ...
                { icon: <TrendingUp className="w-6 h-6 text-orange-400" />, value: stats?.total_archive ? stats.total_archive.toLocaleString() : '8,000+', label: t.statListings, bg: 'bg-orange-500/10', border: 'border-orange-500/20' },
