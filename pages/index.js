...
import { Search, TrendingUp, Clock, Shield, ChevronRight, Globe, CheckCircle, Zap, Users, BarChart3, LogIn, AlertTriangle, Lightbulb, Trophy, Mail, ChevronDown, Plus, Minus } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-blue-400 font-semibold mb-4 flex items-center gap-2">
                <Globe className="w-4 h-4" />{t.tagline}
              </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-1">
                  ...
                  <a href="mailto:contact@ktrix.ai" className="hover:text-gray-400 transition">contact@ktrix.ai</a>
                </p>
              </div>
            </div>
